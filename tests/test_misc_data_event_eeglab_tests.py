...
@eeglab_test(
    "unittesting_miscfunc/getipsph/miscfunc_getipsph_wrapperTest.m",
    "test_test_getipsph",
)
def test_getipsph_current_suite_full_and_reduced_sphering():
...
@eeglab_test(
    "unittesting_miscfunc/rmart/miscfunc_rmart_wrapperTest.m",
    "test_test_rmart",
)
def test_rmart_current_suite_writes_selected_channels_and_reduces_triggered_eog(tmp_path):
...
@eeglab_test(
    "unittesting_sigprocfunc/eventalign/sigprocfunc_eventalign_wrapperTest.m",
    "test_fail_no_arg",
)
def test_eventalign_current_suite_requires_alignment_inputs():
...
def test_eventalign_current_suite_scalar_factor_defaults_to_median():
...
def test_eventalign_current_suite_matrix_row_minima():
...
@eeglab_test(
    "unittesting_sigprocfunc/eventlock/sigprocfunc_eventlock_wrapperTest.m",
    "test_pass_general",
)
def test_eventlock_current_suite_multichannel_infers_frames_and_shifts_trials():
...
def test_eventlock_current_suite_compact_time_axis_and_endpoint_clamping():
