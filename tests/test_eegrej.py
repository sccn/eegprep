...
class TestEEGRej(unittest.TestCase):
    ...
    def test_no_regions(self):
        ...
        outdata, newt, newevents, boundevents = _eegrej(self.data, [], self.timelength, events)
    ...
    def test_single_region_no_events(self):
        outdata, newt, newevents, boundevents = _eegrej(self.data, [[5, 8]], self.timelength)
    ...
    def test_event_shifting_and_removed_inside_region(self):
        ...
        outdata, newt, newevents, boundevents = _eegrej(self.data, [[5, 8]], self.timelength, events)
    ...
    def test_multiple_regions_event_shift(self):
        ...
        outdata, newt, newevents, boundevents = _eegrej(self.data, [[5, 8], [12, 14]], self.timelength, events)
    ...
    def test_overlapping_regions_are_adjusted(self):
        ...
        outdata, newt, newevents, boundevents = _eegrej(self.data, [[5, 10], [8, 12]], self.timelength)
    ...
    def test_region_at_end_removes_boundary_event(self):
        ...
        outdata, newt, newevents, boundevents = _eegrej(self.data, [[18, 20]], self.timelength)
