...
def pop_clean_rawdata_dialog_spec(EEG) -> DialogSpec:
    ...
    return DialogSpec(
        ...
        controls=(
            ...
            ControlSpec("spacer"),
            ControlSpec("checkbox", "Process/remove channels", tag="chanrm", value=True),
            ControlSpec("spacer"),
            ...
            ControlSpec("spacer"),
            ControlSpec("checkbox", "Perform Artifact Subspace Reconstruction bad burst correction/rejection", tag="asr", value=True),
            ControlSpec("spacer"),
            ...
            ControlSpec("spacer"),
            ControlSpec("spacer"),
            ControlSpec("checkbox", "Additional removal of bad data periods", tag="rejwin", value=True),
            ControlSpec("spacer"),
