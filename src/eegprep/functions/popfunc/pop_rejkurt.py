...
from eegprep.functions.popfunc._rejection import kurtosis_marks, parse_numeric_sequence
...
def _apply_one(
    ...
    *,
    ...
    return run_epoched_rejection(
        ...
        reject,
        vistype,
        marks_fn=kurtosis_marks,
        kind="rejkurt",
        stats_local_field="kurtE",
        stats_global_field="kurt",
        stats_local_field_ica="icakurtE",
        stats_global_field_ica="icakurt",
        error_message="pop_rejkurt requires epoched data",
