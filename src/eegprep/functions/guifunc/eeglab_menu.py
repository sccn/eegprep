...
def eeglab_core_menus() -> tuple[MenuItemSpec, ...]:
    ...
    help_menu = menu_item(
        ...
        userdata=ON,
        children=[
            menu_item("About EEGPrep", action="docs", userdata=ON),
            menu_item("Check for EEGPrep updates", action="docs:changelog.html", userdata=ON),
            menu_item("About EEGPrep help", action="docs", userdata=ON),
            menu_item("EEGPrep menus", action="docs:user_guide/index.html", userdata=ON, separator=True),
            menu_item(
                "EEGPrep functions",
                userdata=ON,
                children=[
                    menu_item("Admin. functions", action="docs:api/index.html", userdata=ON),
                    menu_item("Interactive pop_ functions", action="docs:api/index.html", userdata=ON),
                    menu_item("Signal processing functions", action="docs:api/index.html", userdata=ON),
                    menu_item("Group data (STUDY) functions", action="docs:api/index.html", userdata=ON),
                    menu_item("Time-frequency functions", action="docs:api/index.html", userdata=ON),
                    menu_item("Statistical functions", action="docs:api/index.html", userdata=ON),
                    menu_item("Graphic interface builder functions", action="docs:api/index.html", userdata=ON),
                    menu_item("Misc. command line functions", action="docs:api/index.html", userdata=ON),
                ],
            ),
            menu_item("EEGPrep license", action="license", userdata=ON),
            menu_item("EEGPrep tutorial", action="docs:user_guide/quickstart.html", userdata=ON, separator=True),
