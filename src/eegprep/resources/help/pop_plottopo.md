...
The positional form `pop_plottopo(EEG, channels, title, singletrials)` is also
supported. Set `singletrials=1` to overlay the selected dataset trials in each
channel panel instead of plotting the trial average.
