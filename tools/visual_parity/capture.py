...
def _write_matlab_simple_pop_dialog_script(
    ...
    (inputgui_override_dir / "inputgui.m").write_text(
        "\n".join(
            [
                ...
                "[handled, outputs] = capture_existing_mode(varargin, nargout);",
                "if handled",
                "    for output_idx = 1:nargout",
                "        varargout{output_idx} = outputs{output_idx};",
                "    end",
                "    return;",
                "end",
                ...
                "end",
                "",
                "function [handled, outputs] = capture_existing_mode(args, nout)",
                "handled = false;",
                "outputs = cell(1, nout);",
                "if isempty(args) || ~(ischar(args{1}) || isstring(args{1})), return; end",
                "mode_index = [];",
                ...
                "    end",
                "end",
                "if isempty(mode_index), return; end",
                "mode_value = args{mode_index};",
                "if ischar(mode_value) || isstring(mode_value) || ~ishghandle(mode_value), return; end",
                "output_file = getenv('EEGPREP_VISUAL_OUTPUT_FILE');",
                ...
                "end",
                "handled = true;",
                "try, close(mode_value); catch, end",
                "end",
                "",
    ...
    title_by_action = {
        ...
        "pop_newset": "Dataset info -- pop_newset()",
        ...
        "pop_kaiserbeta": "Estimate Kaiser window beta -- pop_kaiserbeta()",
        "pop_firwsord": "Estimate filter order -- pop_firwsord()",
        "pop_firpmord": "Estimate filter order and weights -- pop_firpmord()",
        "pop_xfirws": "Filter the data -- pop_firws()",
        ...
        "pop_precomp": "Select and compute component measures for later clustering -- pop_precomp()",
        "pop_chanplot": "View and edit current channels -- pop_chanplot()",
        "pop_preclust": "Build pre-clustering matrix -- pop_preclust()",
        "pop_clust": "Set clustering algorithm -- pop_clust()",
        "pop_clustedit": "Edit/plot component clusters -- pop_clustedit()",
        "pop_iclabel": "ICLabel",
    ...
    script_path.write_text(
        "\n".join(
            [
                ...
                "        [STUDY, ALLEEG] = std_editset([], ALLEEG, 'name', 'menu study');",
                "        [STUDY, ALLEEG] = std_checkset(STUDY, ALLEEG);",
                "        [STUDY, ALLEEG, com] = pop_precomp(STUDY, ALLEEG);",
                "    case 'pop_chanplot'",
                "        ALLEEG = EEG;",
                "        ALLEEG.setname = 'study targets';",
                "        ALLEEG.filename = 'study_targets.set';",
                ...
                "        ALLEEG.filepath = '/tmp';",
                "        ALLEEG.subject = 'S01';",
                "        ALLEEG.icaweights = eye(4);",
                "        ALLEEG.icasphere = eye(4);",
                "        ALLEEG.icawinv = eye(4);",
                "        [STUDY, ALLEEG] = std_editset([], ALLEEG, 'name', 'menu study');",
                "        [STUDY, ALLEEG] = std_checkset(STUDY, ALLEEG);",
                "        STUDY.cluster(1).name = 'ParentCluster';",
                "        STUDY.cluster(1).sets = [1 1 1 1];",
                "        STUDY.cluster(1).comps = [1 2 3 4];",
                "        STUDY.cluster(1).child = {};",
                "        [STUDY, ALLEEG, com] = pop_preclust(STUDY, ALLEEG);",
                "    case 'pop_clust'",
                "        ALLEEG = EEG;",
                "        ALLEEG.setname = 'study targets';",
                "        ALLEEG.filename = 'study_targets.set';",
                ...
                "        STUDY.cluster(1).comps = [1 2 3 4];",
                "        STUDY.cluster(1).child = {};",
                "        STUDY.etc.preclust.preclustdata = [0 0; 0.1 0; 1 1; 1.1 1];",
                "        STUDY.etc.preclust.preclustparams = {'scalp' 'npca' 2};",
                "        STUDY.etc.preclust.clustlevel = 1;",
                "        [STUDY, ALLEEG, com] = pop_clust(STUDY, ALLEEG);",
                "    case 'pop_clustedit'",
                "        ALLEEG = EEG;",
                "        ALLEEG.setname = 'study targets';",
                "        ALLEEG.filename = 'study_targets.set';",
                ...
                "        STUDY.cluster(1).sets = [1 1 1 1];",
                "        STUDY.cluster(1).comps = [1 2 3 4];",
                "        STUDY.cluster(1).child = {'Cls 1' 'Cls 2'};",
                "        STUDY.cluster(2).name = 'Cls 1';",
                "        STUDY.cluster(2).sets = [1 1];",
                "        STUDY.cluster(2).comps = [1 2];",
                "        STUDY.cluster(2).parent = {'ParentCluster'};",
                "        STUDY.cluster(2).child = {};",
                "        STUDY.cluster(3).name = 'Cls 2';",
                "        STUDY.cluster(3).sets = [1 1];",
                "        STUDY.cluster(3).comps = [3 4];",
                "        STUDY.cluster(3).parent = {'ParentCluster'};",
                "        STUDY.cluster(3).child = {};",
                ...
                "        ALLEEG = EEG;",
                "        CURRENTSET = 1;",
                "        EEG.setname = 'processed demo';",
                "        [ALLEEG, EEG, CURRENTSET, com] = pop_newset(ALLEEG, EEG, CURRENTSET);",
                "    case 'pop_epoch'",
